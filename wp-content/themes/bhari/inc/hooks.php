 ...
 * $bhari_supports[] = 'html;
 */
function bhari_html_before() 
{
    do_action('bhari_html_before');
}
 ...
 * <head> bottom
 */
function bhari_head_bottom() 
{
    do_action('bhari_head_bottom');
}
 ...
 * <body> top
 */
function bhari_body_top() 
{
    do_action('bhari_body_top');
}
 ...
 * Header before
 */
function bhari_header_before() 
{
    do_action('bhari_header_before');
}
 ...
 * Header bottom
 */
function bhari_header_bottom() 
{
    do_action('bhari_header_bottom');
}
 ...
 * Content before
 */
function bhari_content_before() 
{
    do_action('bhari_content_before');
}

/**
 * Content after
 */
function bhari_content_after() 
{
    do_action('bhari_content_after');
}

/**
 * Content top
 */
function bhari_content_top() 
{
    do_action('bhari_content_top');
}

/**
 * Content bottom
 */
function bhari_content_bottom() 
{
    do_action('bhari_content_bottom');
}
